...
void una_lista_recien_creada_tiene_cero_elementos()
{
	...
	pa2m_afirmar(lista_tamanio(lista) == 0,
		     "El tamaño de la lista recien creada es 0");
	lista_destruir(lista);
}
...
void los_punteros_de_una_lista_recien_creada_apuntan_a_null()
{
	...
	pa2m_afirmar(lista_primero(lista) == NULL,
		     "nodo_incio apunta a NULL con una lista recien creada");
...
void no_puedo_insertar_con_lista_nula()
{
	...
	pa2m_afirmar(
		...
		"No se puede insertar elementos al final de una lista nula");
	lista_destruir(lista);
}
...
void se_inserta_un_elemento_en_el_final_correctamente()
{
	...
	pa2m_afirmar(lista_ultimo(lista) == &insertar,
		     "El elemento insertado en el final es correcto");
	lista_destruir(lista);
}
...
void no_se_puede_insertar_en_posiciones_aleatorias_en_una_lista_nula()
{
	...
	int numero;
	pa2m_afirmar(
		lista_insertar_en_posicion(lista, &numero, 2) == NULL,
		"No se puede insertar elementos en posiciones arbitrarias en una lista nula");
}
...
void se_puede_insertar_en_posiciones_aleatorias()
{
	...
	pa2m_afirmar(
		lista_elemento_en_posicion(lista, 2) == &nuevo_numero,
		"Se puede insertar elementos en posiciones aleatorias correctamente");
	lista_destruir(lista);
}
...
void inserto_un_elemento_en_una_posicion_que_no_existe_y_se_inserta_al_final()
{
	...
	pa2m_afirmar(
		lista_ultimo(lista) == &nuevo_numero,
		"Inserto en una posicion que no existe y se inserta al final");
	lista_destruir(lista);
}
...
void se_pueden_eliminar_elementos_de_final_de_una_lista()
{
	...
	pa2m_afirmar(
		lista_quitar(lista) == &numeros[7],
		"Se puede eliminar elementos de la ultima posicion y son correctos");
	lista_destruir(lista);
}
...
{
	lista_t *lista = NULL;
	pa2m_afirmar(lista_quitar_de_posicion(lista, 45) == NULL,
		     "No se puede quitar elementos de una lista nula");
}
...
void se_pueden_eliminar_elementos_en_posiciones_aleatorias()
{
	...
	for (int i = 0; i < sizeof(numeros) / sizeof(int); i++)
		lista = lista_insertar(lista, &numeros[i]);
	pa2m_afirmar(
		lista_quitar_de_posicion(lista, 5) == &numeros[5],
		"Se puede eliminar el elemento de una posicion arbitraria correctamente");
	lista_destruir(lista);
}
...
void no_se_puede_elimina_elementos_de_una_lista_vacia()
{
	...
	pa2m_afirmar(
		...
		"No puedo eliminar elementos del final de una lista vacia");
	lista_destruir(lista);
}
...
void no_se_puede_eliminar_elementos_en_posiciones_aleatorias_de_una_lista_vacia()
{
	lista_t *lista = lista_crear();
	pa2m_afirmar(
		lista_quitar_de_posicion(lista, 5) == NULL,
		"No puedo eliminar elementos del final de una lista vacia");
	lista_destruir(lista);
}
...
void elimino_en_una_posicion_que_no_existe_y_se_elimina_el_ultimo()
{
	...
	for (int i = 0; i < sizeof(numeros) / sizeof(int); i++)
		lista = lista_insertar(lista, &numeros[i]);
	pa2m_afirmar(
		lista_quitar_de_posicion(lista, 654654) == &numeros[7],
		"Elimino el elemento de una posicion que no existe y se elimina el ultimo");
	lista_destruir(lista);
}
...
void no_puedo_buscar_elementos_en_una_posicion_en_una_lista_nula()
{
	...
	pa2m_afirmar(
		...
		"No puedo buscar un elemento en una poscion en una lista nula");
}
...
void no_puedo_buscar_elementos_en_una_posicion_en_una_lista_vacia()
{
	...
	pa2m_afirmar(
		...
		"No puedo buscar un elemento segun su posicionen una lista vacica");
	lista_destruir(lista);
}
...
void busco_en_una_posicion_un_elemento_y_lo_encuentro()
{
	...
	for (int i = 0; i < sizeof(numeros) / sizeof(int); i++)
		lista = lista_insertar(lista, &numeros[i]);
	pa2m_afirmar(lista_elemento_en_posicion(lista, 4) == &numeros[4],
		     "Busco un elemento segun su posicion y lo encuentro");
	lista_destruir(lista);
}
...
void busco_un_elemento_en_una_posicion_que_no_existe_y_no_lo_encuentro()
{
	...
	for (int i = 0; i < sizeof(numeros) / sizeof(int); i++)
		lista = lista_insertar(lista, &numeros[i]);
	pa2m_afirmar(
		lista_elemento_en_posicion(lista, 40) == NULL,
		"Busco un elemento en una posicion que no existe y no lo encuentro");
	lista_destruir(lista);
}
...
void si_la_funcion_es_null_no_se_le_aplica_a_ningun_elemento()
{
	...
	for (int i = 0; i < sizeof(numeros) / sizeof(int); i++)
		lista = lista_insertar(lista, &numeros[i]);
	pa2m_afirmar(lista_con_cada_elemento(lista, NULL, &numeros[5]) == 0,
		     "No se puede aplicar una funcion NULL");
	lista_destruir(lista);
}
...
void puedo_aplicarle_la_funcion_a_todos_los_elementos_de_la_lista()
{
	...
	for (int i = 0; i < sizeof(numeros) / sizeof(int) - 1; i++)
		lista = lista_insertar(lista, &numeros[i]);
	pa2m_afirmar(lista_con_cada_elemento(lista, es_el_buscado,
					     &numeros[5]) == 5,
		     "Se le aplica la funcion a todos los elementos");
	lista_destruir(lista);
}
...
void puedo_aplicarle_la_funcion_a_algunos_los_elementos_de_la_lista()
{
	...
	pa2m_afirmar(lista_con_cada_elemento(lista, es_el_buscado,
					     &numeros[1]) == 2,
		     "Se le aplica la funcion a algunos elementos");
	lista_destruir(lista);
}
...
void no_puedo_crear_un_it_con_una_lista_nula()
{
	...
	pa2m_afirmar(it == NULL,
		     "No puedo crear un iterador externo con una lista nula");
}
...
void puedo_crear_un_it_externo()
{
	...
	pa2m_afirmar(it != NULL,
		     "Puedo crear un iterador externo con una lista no nula");
...
void creo_un_it_externo_y_apunta_al_primer_elemento_de_la_lista()
{
	...
	lista_iterador_t *it = lista_iterador_crear(lista);
	pa2m_afirmar(
		lista_iterador_elemento_actual(it) == &numero,
		"Creo un iterador externo y este apunta al primer elemento de la lista");
	lista_iterador_destruir(it);
	lista_destruir(lista);
}
...
void no_puedo_recorrer_una_lista_vacia()
{
	...
	pa2m_afirmar(lista_iterador_avanzar(it) == false,
		     "No puedo avanzar con una lista vacia");
...
void puedo_recorrer_una_lista()
{
	...
	pa2m_afirmar(elementos_recorridos == 5,
		     "Se recorrieron todos los elementos de la lista");
	lista_iterador_destruir(it);
	lista_destruir(lista);
}
...
void puedo_encolar_un_elemento()
{
	...
	pa2m_afirmar(cola_frente(cola) == &numero,
		     "Se puede encolar un elemento en la cola y es correcto");
	cola_destruir(cola);
}
...
void puedo_desencolar_un_elemento()
{
	...
	pa2m_afirmar(
		cola_tamanio(cola) == 0 && elemento == &numero,
		"Se puede desencolar un elemento en la cola y es correcto");
	cola_destruir(cola);
}
...
void puedo_encolar_varios_elementos()
{
	...
	pa2m_afirmar(cola_tamanio(cola) == 4,
		     "Se encolaron todos los elementos correctamente");
	cola_destruir(cola);
}
...
void puedo_desencolar_todos_los_elementos()
{
	...
	while (!cola_vacia(cola)) {
		pa2m_afirmar(cola_desencolar(cola) == &numeros[i],
			     "El elemento desencolado es correcto");
		i++;
	}
	pa2m_afirmar(cola_tamanio(cola) == 0,
		     "Se desencolaron todos los elementos");
	cola_destruir(cola);
}
...
void no_puedo_apilar_en_una_pila_nula()
{
	...
	pa2m_afirmar(pila_apilar(pila, NULL) == NULL,
		     "No se puede apilar en una pila nula");
}
...
void puedo_apilar_un_elemento()
{
	...
	pa2m_afirmar(pila_tope(pila) == NULL,
		     "El elemento apilado es correcto");
	pa2m_afirmar(pila_tamanio(pila) == 1,
		     "El tamaño de la pila es correcto");
	pila_destruir(pila);
}
...
void puedo_desapilar_un_elemento()
{
	...
	pa2m_afirmar(pila_desapilar(pila) == NULL,
		     "Puedo desapilar un elemento correctamente");
...
void puedo_apilar_varios_elementos()
{
	...
	pa2m_afirmar(pila_tamanio(pila) == 4,
		     "La cantidad de elementos insertada es correcta");
	pila_destruir(pila);
}
...
void puedo_desapilar_todos_los_elementos()
{
	...
	while (!pila_vacia(pila)) {
		pa2m_afirmar(pila_desapilar(pila) == &numeros[i],
			     "El elemento desapilado es correcto");
		i--;
	}
